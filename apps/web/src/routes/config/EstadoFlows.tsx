...
export default function EstadoFlows() {
  ...
  const [editingFlow, setEditingFlow] = React.useState<EstadoFlowDetail | null>(null);
  ...
  async function openEditor(tipoId: string) {
    ...
    try {
      const flow = await getEstadoFlowByTipoTarea(tipoId);
      if (flow) {
        setEditingFlow(flow);
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (editingFlow) {
        await updateEstadoFlow(editingFlow.id, data);
      } else {
        await createEstadoFlow(data);
      }
  ...
  async function handleDelete(tipoTareaId: string) {
    if (!confirm("¿Esta seguro de eliminar el flujo de estados para este tipo de tarea?")) return;

    try {
      await deleteEstadoFlow(tipoTareaId);
  ...
  return (
    <div className="grid">
      <div className="topbar">
        <div className="h1">Flujos de Estado</div>
      ...
      <div className="card" style={{ padding: 24 }}>
        <div style={{ marginBottom: 16 }}>
          <p style={{ color: "var(--muted)", fontSize: 13 }}>
            Configure las transiciones de estado permitidas para cada tipo de tarea.
            Si no se configura un flujo, se permiten todas las transiciones.
          </p>
        </div>
          ...
          >
            <div style={{ padding: "16px 24px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <h2 style={{ fontSize: 18, fontWeight: 600 }}>
                Flujo de Estados: {getTipoLabel(editingTipoId)}
              </h2>
            ...
            <div style={{ flex: 1, overflow: "auto", padding: 24 }}>
              ...
              <div className="field" style={{ marginBottom: 20 }}>
                ...
                <div className="small" style={{ marginTop: 4, color: "var(--muted)" }}>
                  Estado inicial para nuevas tareas de este tipo
                </div>
              </div>

              {/* Estados Permitidos */}
              <div style={{ marginBottom: 24 }}>
                <div className="label" style={{ marginBottom: 8 }}>Estados Permitidos</div>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <div className="small" style={{ marginTop: 8, color: "var(--muted)" }}>
                  Define que transiciones estan permitidas y quien puede realizarlas.
                </div>
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div className="small" style={{ marginTop: 4, color: "var(--muted)", marginLeft: 24 }}>
                  Si el flujo esta inactivo, se permiten todas las transiciones.
                </div>
              </div>
            </div>
